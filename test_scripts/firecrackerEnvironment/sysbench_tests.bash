...
# Test the memory bandwidth of the server
  ...
  do
    ...
    do
      ...
      do
        ...
        sysbench memory --memory-total-size=1000G --threads="$i" --memory-block-size=8M --memory-access-mode="$k" --memory-oper="$l" --memory-scope="$m" --time=30  run >> "bareMetalOutputs/results_${i}_${k}_${l}_${m}.txt"
      done
    done
  done
done
